package com.chinatsp.example.floatball;
...
import com.chinatsp.example.floatball.permission.FloatPermissionManager;
...
//        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
        ...
        findViewById(R.id.btn_choose_menu).setOnClickListener(this);
...
//        FloatBallCfg ballCfg = new FloatBallCfg(ballSize, ballIcon, FloatBallCfg.Gravity.RIGHT_TOP, 100);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.btn_open:
                mFloatballManager.openMenu();
                view.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        mFloatballManager.chooseMenuItem(Gravity.BOTTOM);
                    }
                },1500);
                break;
            case R.id.btn_close:
                mFloatballManager.closeMenu();
                break;
            case R.id.btn_choose_menu:
                EditText et = findViewById(R.id.et);
                int gravity = Integer.valueOf(et.getText().toString());
                switch (gravity){
                    case 1:
                ...
                mFloatballManager.chooseMenuItem(gravity);
                break;
        }
    }
