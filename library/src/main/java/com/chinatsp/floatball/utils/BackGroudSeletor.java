...
public class BackGroudSeletor {
    static int[] PRESSED_ENABLED_STATE_SET = {android.R.attr.state_enabled, android.R.attr.state_pressed};// debug出的该变量在view中的值
    static int[] ENABLED_STATE_SET = {android.R.attr.state_pressed};
