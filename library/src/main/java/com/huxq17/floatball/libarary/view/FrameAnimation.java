package com.huxq17.floatball.libarary.view;
...
public class FrameAnimation {
     ...
     */
    public FrameAnimation(View iv, int[] frameRes, int duration, boolean isRepeat) {
        this.mView = iv;
...
//        play(0);
     ...
     * @param isRepeat  是否循环播放
     */
    public FrameAnimation(View iv, int[] frameRess, int[] durations, boolean isRepeat) {
        this.mView = iv;
     ...
     */
    public FrameAnimation(View iv, int[] frameRess, int duration, int delay) {
        this.mView = iv;
        this.mFrameRess = frameRess;
        this.mDuration = duration;
        this.mDelay = delay;
     ...
     * @param delay     循环播放的时间间隔
     */
    public FrameAnimation(View iv, int[] frameRess, int[] durations, int delay) {
        this.mView = iv;
        this.mFrameRess = frameRess;
        this.mDurations = durations;
        this.mDelay = delay;
    ...
    private void playByDurationsAndDelay(final int i) {
        mView.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                mView.setBackgroundResource(mFrameRess[i]);
                if (i == mLastFrame) {
                    if (mAnimationListener != null) {
